  ...
  <nav class="navbar navbar-expand topbar static-top">
    ...
    <ul v-if="userInfo != null" class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown no-arrow">
        ...
        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
          ...
          <div class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal" @click="logout()">
    ...
    <ul v-else class="navbar-nav ml-auto">
      <li class="nav-item nav-link">
        <div class="nav-link" href="#" id="userDropdown">
          <div>
            <router-link to="/login" class="mr-2 d-none d-lg-inline text-gray-600 small font-weight-bold">Try Login
            </router-link>
          </div>
        </div>
      </li>
